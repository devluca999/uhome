-- Stripe Connect + payments core tables (promoted from archive/add_stripe_tables.sql).
-- Must run before 20260322000001_add_missing_stripe_columns.sql (which ALTERs public.payments).
