          ...
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Property: {selectedConv?.property_name || 'Unknown'} | Lease ID:{' '}
                  {selectedLeaseId.substring(0, 8)}...
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      <Badge variant="outline">
                        Tenants: {selectedConv?.tenant_emails.join(', ') || 'None'}
                      </Badge>
                      <Badge variant="outline">
                        Landlords: {selectedConv?.landlord_emails.join(', ') || 'None'}
                      </Badge>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Inspect tenant-landlord message threads (read-only)
            </p>
          </div>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="space-y-1 text-sm text-muted-foreground">
                          <p>
                            ...
                            {conversation.tenant_emails.join(', ') || 'None'}
                          </p>
                          <p>
                            <strong>Landlords:</strong>{' '}
                            {conversation.landlord_emails.join(', ') || 'None'}
                          </p>
